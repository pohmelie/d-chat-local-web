...
(function() {
  ...
  construct = (function() {
    ...
    construct.copy = function(obj, visited) {
      ...
      if (obj instanceof Array) {
        c = [];
        visited.push([obj, c]);
        for (o = 0, len1 = obj.length; o < len1; o++) {
          v = obj[o];
  ...
  xsha1 = (function() {
    ...
    xsha1.do_hash = function(hash_buffer) {
      var a, b, buf, c, d, dw, e, i, l, o, p, ref, results;
      buf = [];
      for (i = l = 1; l <= 80; i = ++l) {
        buf.push(0);
      }
  ...
  bnutil = (function() {
    ...
    bnutil.hash_d2key = function(cdkey, client_token, server_token) {
      var checksum, hash_data, i, l, m_key, n, o, public_value, q, ref, ref1, ref2, ref3, t, v2;
      checksum = 0;
      m_key = [];
      ...
      for (i = o = ref1 = cdkey.length - 1; o >= 0; i = o += -1) {
        n = (i - 9) & 0xf;
        ref2 = [m_key[n], m_key[i]], m_key[i] = ref2[0], m_key[n] = ref2[1];
      }
      v2 = 0x13AC9741;
      for (i = q = ref3 = cdkey.length - 1; q >= 0; i = q += -1) {
  ...
  socket = (function() {
    ...
    socket.WebSocketBridge = (function() {
      function WebSocketBridge(on_data, on_error) {
        ...
        this.socket.onclose = (function(_this) {
          return function() {
            return _this.websocket_ok = false;
          };
        })(this);
