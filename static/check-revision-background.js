...
(function() {
  ...
  this.onmessage = function(event) {
    var file_name, ref, seed_values;
    ref = JSON.parse(event.data), seed_values = ref[0], file_name = ref[1];
    postMessage(JSON.stringify({
      done: false,
      result: null,
      percents: 0
    }));
    return load_files(["d2xp/Game.dll", "d2xp/Bnclient.dll", "d2xp/D2Client.dll"], ((function(_this) {
      return function(d) {
  ...
  check_revision = function(formula, mpq, a) {
    var A, B, C, S, bin, body, exprs, i, init, j, k, mpq_hash, offset, ref, ref1, step, step_count, tail, v;
    ...
    body = "";
    for (i = j = 4, ref = 4 + Number(exprs[3]); 4 <= ref ? j < ref : j > ref; i = 4 <= ref ? ++j : --j) {
      ref1 = exprs[i].split("="), k = ref1[0], v = ref1[1];
